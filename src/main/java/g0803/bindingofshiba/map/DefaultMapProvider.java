...
public class DefaultMapProvider implements MapProvider {
    ...
    public Room getFirstRoom() {
        Room trollRoom = new Room(Constants.ROOM_WIDTH, Constants.ROOM_HEIGHT, null, List.of(
                new Obstacle(6, 7),
                new Obstacle(50, 55),
                new Obstacle(23, 44),
                new Obstacle(80, 25)
        ...
        Room fightRoom = new Room(Constants.ROOM_WIDTH, Constants.ROOM_HEIGHT, List.of(
        ...
        Room allMonsters = new Room(Constants.ROOM_WIDTH, Constants.ROOM_HEIGHT, List.of(
                ...
                new Obstacle(new Vec2D(Constants.ROOM_WIDTH / 2D, Constants.ROOM_HEIGHT / 2D))
        ));

        Door trollToAllMonsters = new Door(trollRoom, DoorPosition.RIGHT, allMonsters, DoorPosition.LEFT);
        trollRoom.addDoor(trollToAllMonsters);
        allMonsters.addDoor(trollToAllMonsters);

        Door allMonstersToTroll = new Door(allMonsters, DoorPosition.BOTTOM, trollRoom, DoorPosition.TOP);
        allMonsters.addDoor(allMonstersToTroll);
        trollRoom.addDoor(allMonstersToTroll);

        Door allMonstersToFight = new Door(allMonsters, DoorPosition.TOP, fightRoom, DoorPosition.RIGHT);
